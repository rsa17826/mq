  ...
  o.prototype = {
    ...
    play: function (e, o) {
      ...
      if (t._webAudio) {
        var m = function () {
          ...
          p.gain.setValueAtTime(e, n.ctx.currentTime),
            ...
            void 0 === p.bufferSource.start
              ...
              : a._loop
              ? p.bufferSource.start(0, i, 86400)
              : p.bufferSource.start(0, i, d),
            _ !== 1 / 0 &&
              (t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), _)),
            o ||
              setTimeout(function () {
        ...
        "running" === n.state
          ? m()
          : ((t._playLock = !0), t.once("resume", m), t._clearTimer(a._id))
      } else {
        var v = function () {
            ;(p.currentTime = i),
            ...
            try {
              ...
              "__default" !== e || a._loop
                ...
                : ((t._endTimers[a._id] = function () {
                    t._ended(a),
                      p.removeEventListener("ended", t._endTimers[a._id], !1)
                  }),
