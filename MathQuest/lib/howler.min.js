        ...
        var t = function (n) {
          ...
          for (var o = 0; o < e._howls.length; o++)
            if (!e._howls[o]._webAudio)
              for (
                var a = e._howls[o]._getSoundIds(), u = 0;
                u < a.length;
                u++
              ) {
  ...
  o.prototype = {
    init: function (e) {
      ...
      return (
        ...
        (o._onloaderror =
          e.onloaderror ? [{ fn: e.onloaderror }] : []),
        (o._onplayerror =
          e.onplayerror ? [{ fn: e.onplayerror }] : []),
    ...
    play: function (e, o) {
      ...
      var i = Math.max(
          0,
          a._seek > 0 ? a._seek : t._sprite[e][0] / 1e3,
        ),
        d = Math.max(
          0,
          (t._sprite[e][0] + t._sprite[e][1]) / 1e3 - i,
        ),
      ...
      if (t._webAudio) {
        var m = function () {
          ...
          ;(p.gain.setValueAtTime(e, n.ctx.currentTime),
            (a._playStart = n.ctx.currentTime),
            void 0 === p.bufferSource.start ?
              a._loop ?
                p.bufferSource.noteGrainOn(0, i, 86400)
              : p.bufferSource.noteGrainOn(0, i, d)
            : a._loop ? p.bufferSource.start(0, i, 86400)
            : p.bufferSource.start(0, i, d),
            _ !== 1 / 0 &&
        ...
        var v = function () {
            ;((p.currentTime = i),
              (p.muted = a._muted || t._muted || n._muted || p.muted),
              (p.volume = a._volume * n.volume()),
                ...
                ((
                  ...
                  r
                    .then(function () {
                      ;((t._playLock = !1),
                        (p._unlocked = !0),
                        o || (t._emit("play", a._id), t._loadQueue()))
                    })
                    .catch(function () {
                      ;((t._playLock = !1),
                        t._emit(
          ...
          h =
            ...
            (!p.readyState && n._navigator.isCocoonJS)
        if (p.readyState >= 3 || h) v()
          ...
          ;(p.addEventListener(n._canPlayEvent, y, !1),
            t._clearTimer(a._id))
        }
      }
      return a._id
    ...
    volume: function () {
      ...
      if (!(void 0 !== e && e >= 0 && e <= 1))
        return (
          (a = o ? t._soundById(o) : t._sounds[0]),
          a ? a._volume : 0
        )
      if ("loaded" !== t._state || t._playLock)
        return (
      ...
      for (var d = 0; d < o.length; d++)
        if ((i = t._soundById(o[d]))) {
          ;(t.playing(o[d]) &&
            ...
            (i._playStart =
              t._webAudio ? n.ctx.currentTime : i._playStart)),
            (i._rate = e),
          ...
          var _ = t.seek(o[d]),
            s =
              (t._sprite[i._sprite][0] + t._sprite[i._sprite][1]) /
                1e3 -
              _,
    ...
    seek: function () {
      ...
      if (i) {
        if (!("number" == typeof e && e >= 0)) {
          if (t._webAudio) {
            var d =
                t.playing(o) ? n.ctx.currentTime - i._playStart : 0,
    ...
    _emit: function (e, n, o) {
      for (
        var t = this, r = t["_on" + e], a = r.length - 1;
        a >= 0;
        a--
      )
        ...
        a =
          (
            (function (e) {
              ...
              "undefined" != typeof Promise &&
                1 === n.ctx.decodeAudioData.length,
            )
          ) ?
    ...
    (Howl.prototype.init = (function (e) {
      return function (n) {
        ...
        return (
          ...
          (t._onorientation =
            n.onorientation ? [{ fn: n.onorientation }] : []),
          e.call(this, n)
        )
      }
    })(Howl.prototype.init)),
    ...
    (Howl.prototype.pannerAttr = function () {
      ...
      for (var a = o._getSoundIds(t), s = 0; s < a.length; s++)
        if ((r = o._soundById(a[s]))) {
          ...
          p = {
            coneInnerAngle:
              void 0 !== n.coneInnerAngle ?
                n.coneInnerAngle
              : p.coneInnerAngle,
            coneOuterAngle:
              void 0 !== n.coneOuterAngle ?
                n.coneOuterAngle
              : p.coneOuterAngle,
            coneOuterGain:
              void 0 !== n.coneOuterGain ?
                n.coneOuterGain
              : p.coneOuterGain,
            distanceModel:
              void 0 !== n.distanceModel ?
            ...
            refDistance:
              ...
              : p.refDistance,
            rolloffFactor:
              void 0 !== n.rolloffFactor ?
                n.rolloffFactor
              : p.rolloffFactor,
            panningModel:
              void 0 !== n.panningModel ?
                n.panningModel
              : p.panningModel,
          }
          var c = r._panner
